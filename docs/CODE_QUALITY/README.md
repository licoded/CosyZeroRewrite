...
| 指标 | 数值 | 评估 |
|------|------|------|
| 代码重复率 | 2.51% (216/8592 行) | ✅ 良好 (<5%) |
| Token 重复率 | 3.3% (2325/70449) | ✅ 良好 |
| 平均圈复杂度 | 4.7 | ✅ 良好 (<10) |
| 高复杂度函数 (CCN>20) | 16 个 | ⚠️ 需关注 |

### 使用的检测工具

| 工具 | 类型 | 检测结果 |
|------|------|----------|
| **jscpd** | Token-based | 21 处重复 |
| **lizard** | Complexity-based | 16 个高复杂度函数 |
| **clang-tidy** | AST-based | 冗余模式检测 |

详见: [code_duplication.md](./code_duplication.md)
